...
class CheckpointManager:
    ...
    def save(self, step, validation_accuracy_source=None,
        ...
        if validation_accuracy_source is not None:
            if self.best_validation_source is None or validation_accuracy_source > self.best_validation_source :
                ...
                write_best_valid(self.log_dir,
                    ...
                    filename="best_valid_accuracy_source.txt")
                print("best source save:%f"%(validation_accuracy_source))

        if validation_accuracy_target is not None:
            if self.best_validation_target is None or validation_accuracy_target > self.best_validation_target :
                ...
                write_best_valid(self.log_dir,
                    ...
                    filename="best_valid_accuracy_target.txt")
                print("best target:%f" % (validation_accuracy_target))
