...
class uWaveBase(Dataset):
    ...
    def local(self):
        return "./datasets/"+"uWaveGestureLibrary.zip"
...
class UciHarBase(Dataset):
    ...
    def local(self):
        return "./datasets/"+"UCI%20HAR%20Dataset.zip"
...
class UciHHarBase(Dataset):
    ...
    def local(self):
        return "./datasets/"+"Activity%20recognition%20exp.zip"
...
class WisdmBase(Dataset):
    ...
    def local(self):
        return "./datasets/"+"WISDM_at_latest.tar.gz"
